var levels = [
  {
    ...
    selectorName : "Выбор типа",
    doThis : "Выберите пластины",
    selector : "plate",
    syntax : "A",
    help : "Выбирает все элементы типа <strong>A</strong>. Тип относится к типу тега, поэтому <tag>div</tag>, <tag>p</tag> и <tag>ul</tag> все это разные типы элементов.",
    examples : [
